...
public class FloatingHintEditText2 extends EditText {
  ...
  public FloatingHintEditText2(Context context) {
    this(context, null);
  }

  public FloatingHintEditText2(Context context, AttributeSet attrs) {
    this(context, attrs, R.attr.floatingHintEditTextStyle);
  }

  public FloatingHintEditText2(Context context, AttributeSet attrs, int defStyle) {
