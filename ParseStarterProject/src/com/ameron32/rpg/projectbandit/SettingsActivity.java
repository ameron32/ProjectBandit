...
import com.parse.starter.R.string;
import com.parse.starter.R.xml;
...
public class SettingsActivity extends PreferenceActivity {
   ...
   */
  private static boolean doPref(Preference preference, Object value) {
    ...
    if (preference instanceof CheckBoxPreference) {
      ...
      int newValue = 0;
      if (cb.isChecked()) {
        // TODO Store the small value
        newValue = R.layout.row_message_sml;
        // reflect the summary
        cb.setSummary("Unselect to use larger chat sizes.");
      }
      else {
        // TODO Store the medium value
        newValue = R.layout.row_message;
        // reflect the summary
        cb.setSummary("Select to use smaller chat sizes.");
      }
      
      SharedPreferences preferences = cb.getContext().getSharedPreferences("size", Context.MODE_PRIVATE);
      Editor editor = preferences.edit();
      editor.putInt("message_row", newValue);
      editor.commit();
    }
    ...
    if (preference instanceof ListPreference) {
      ...
      if (preference instanceof RingtonePreference) {
        ...
        /*
         * For all other preferences, set the summary to the value's simple
  ...
  private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
                                                                                               ...
                                                                                               public boolean onPreferenceChange(
                                                                                                   ...
                                                                                                   Object value) {
                                                                                                 return doPref(preference, value);
                                                                                               }
                                                                                             };
