...
////  String myNotes;
  ...
  private static Column[] columns = {
    ...
    new Column(SATTRIBUTE, _DataType.String),
    new Column(SDIFFICULTY, _DataType.String),
    new Column(BHASSUBSKILLS, _DataType.Boolean),
    new Column(SLISTDEFAULTS, _DataType.ListOfStrings),
    new Column(BEXIST, _DataType.Boolean),
    new Column(SALTATT, _DataType.String),
    new Column(SALTDIFF, _DataType.String),
    new Column(SLISTCATEGORIESANDSUBCATEGORIES, _DataType.ListOfStrings),
    new Column(BREQUIRESSPECIALIZATION, _DataType.Boolean),
