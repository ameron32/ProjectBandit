...
public class CharacterSelectorAdapter_v2 extends
    RecyclerView.Adapter<CharacterSelectorAdapter_v2.ViewHolder> {
  ...
  public CharacterSelectorAdapter_v2(Context context) {
    super();
