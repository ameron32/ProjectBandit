 ...
 */
public abstract class ResettingContentFragment
    extends ContentFragment
    implements ResettingFragmentAsyncTask.FragmentTaskCallbacks
{
  
  private static final String TAG = ResettingContentFragment.class.getSimpleName();
  ...
  public interface OnResetCallbacks {
    public void onRequestReset(ResettingContentFragment fragment);
  }
}
