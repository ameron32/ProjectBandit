    ...
    for (int i = 0; i < selectedObjects1.size(); i++) {
      ...
      for (int j = 0; j < selectedObjects2.size(); j++) {
        ...
        if (object2Type.equals("_User")) {
          ParseObject pO = _ParseUtils.addUserRelationToObject(type1, name1, relation, type2, name2);
          toSave.add(pO);
        } else {
          ParseObject pO = _ParseUtils.addObjectRelationToObject(type1, name1, relation, type2, name2);
          toSave.add(pO);
        }
      }
    }
