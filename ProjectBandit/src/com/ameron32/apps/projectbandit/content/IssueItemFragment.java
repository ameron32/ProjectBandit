...
public class IssueItemFragment extends
  ...
  private <T extends ParseObject> void runItemQuery() {
    ...
    if (inGameItem != null && inGameItem.isChecked()) {
      query = (ParseQuery<T>) _QueryManager._Item.getItemQuery();
    } else {
      query = (ParseQuery<T>) _QueryManager._Item.getFullItemQuery();
    }
  ...
  private <T extends ParseObject> void runCharacterQuery() {
    ...
    if (inGameCharacter != null && inGameCharacter.isChecked()) {
      query = (ParseQuery<T>) _QueryManager._Character.getPlayableCharacters();
    } else {
      query = (ParseQuery<T>) _QueryManager._Character.getAllLibraryCharacters();
    }
